...
static Future<void> getFirebaseMessagingToken () async{
  await fMessaging.requestPermission();
    // for setting user statue of active
...
headers: {
  ...
  HttpHeaders.authorizationHeader : 
    'key =  AAAA2SQvC-U:APA91bGKqp1hmtVKop1uAyXmdBcm8hhHEAz_7Fj3Qp4B2k8ATlKZZ3JKLbE7vPs9-c4E3P_KaX8YOUqZApp_10w4UfisNC2h-KPf5lrT7T6Ly40ZFkSEEiEQLsZzZ0TboUHn1Sb5EzOT' 
},
...
static Stream<QuerySnapshot<Map<String, dynamic>>> getMyIUsersId(){
  return firestore
  .collection('users')
  .doc(user.uid)
  .collection('my_users')
...
static Stream<QuerySnapshot<Map<String, dynamic>>> getAllUsers(List<String> userIds){
 ...
 //for adding an user when first message is send
...
//use full for getting conversation id
...
(toId: ChatUser.id, msg: msg, read: '', type: type, fromId: user.uid, sent: time);
